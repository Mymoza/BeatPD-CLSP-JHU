...
from keras.layers import Add, Flatten, GRU
...
def make_LSTM_model(feat_size=30,num_neuron=10,out_feat_size=1,mode='regression'):
    ...
    #clf = Dense(num_neuron)(clf)
    #clf = LSTM(num_neuron,return_sequences=True)(clf)
    clf = LSTM(num_neuron)(clf)
    #clf = GRU(num_neuron)(clf)   
